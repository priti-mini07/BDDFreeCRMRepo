...
public class ContactsPage extends TestBase {
	...
	public ContactsPage() {
		...
		PageFactory.initElements(BrowserFactory.getInstance().getDriver(), this);
	...
	public void enterDetailsOfNewContact(String fname,String lName, String company, String socialAcct, String description) {
		...
		BrowserFactory.getInstance().getDriver().findElement(By.xpath("//label[text()='Company']/following::div[@role='option']//b[contains(text(),'"+company+"')]")).click();;
		socialChannel.click();
		BrowserFactory.getInstance().getDriver().findElement(By.xpath("(//label[text()='Social Channels']/following::div[@role='option']/following::span[text()='"+socialAcct+"'])[1]")).click();
